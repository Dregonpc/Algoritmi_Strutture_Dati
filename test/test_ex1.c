...
void merge_test_null_array(void) {
    int *testMerge = NULL;
...
void quick_test_null_array(void) {
    int *testQuick = NULL;
...
void merge_test_positive_int_array(void) {
...
void quick_test_positive_int_array(void) {
...
void merge_test_negative_int_array(void) {
    int testMerge[] = {-14, -2, -97, -54, -11, -17, -34, -28, -55, -1};
...
void quick_test_negative_int_array(void) {
    int testQuick[] = {-14, -2, -97, -54, -11, -17, -34, -28, -55, -1, -22, -84, -5, -7, -222, -69, -152, -468, -874, -52};
...
void merge_test_int_array(void) {
    int testMerge[] = {14, -2, 97, -54, 11, -17, 34, -28, 55, 1};
...
void quick_test_int_array(void) {
    int testQuick[] = {14, -2, 97, -54, 11, -17, 34, -28, 55, -1, 22, -84, 5, -7, 222, -69, 152, -468, 874, -52};
...
void merge_test_long_array(void) {
...
void quick_test_long_array(void) {
...
void merge_test_float_array(void) {
...
void quick_test_float_array(void) {
...
void merge_test_double_array(void) {
...
void quick_test_double_array(void) {
...
void merge_test_char_array(void) {
...
void quick_test_char_array(void) {
    char testQuick[] = {'b', 'l', 'e', 'c', 'h', 'a', 'd', 'g', 'f', 'i', 'y', 'q', 'x', 's', 't', 'w', 'm', 'k', 'n', 'p'};
    char expectedQuick[] = {'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'k', 'l', 'm', 'n', 'p', 'q', 's', 't', 'w', 'x', 'y'};
    quick_sort(testQuick, 20, sizeof(testQuick[0]), compare_char);
    TEST_ASSERT_EQUAL_INT8_ARRAY(expectedQuick, testQuick, 20);
...
void merge_test_string_array(void) {
...
void quick_test_string_array(void) {
...
void merge_test_already_sorted_array(void) {
...
void quick_test_already_sorted_array(void) {
...
void merge_test_with_only_duplicated(void) {
...
void quick_test_with_only_duplicated(void) {
...
int main (void) {
    ...
    RUN_TEST(merge_test_null_array);
    RUN_TEST(merge_test_positive_int_array);
    RUN_TEST(merge_test_negative_int_array);
    RUN_TEST(merge_test_int_array);
    RUN_TEST(merge_test_long_array);
    RUN_TEST(merge_test_float_array);
    RUN_TEST(merge_test_double_array);
    RUN_TEST(merge_test_char_array);
    RUN_TEST(merge_test_string_array);
    RUN_TEST(merge_test_already_sorted_array);
    RUN_TEST(merge_test_with_only_duplicated);

    printf("\nQuick sort tests : \n");
    RUN_TEST(quick_test_null_array);
    RUN_TEST(quick_test_positive_int_array);
    RUN_TEST(quick_test_negative_int_array);
    RUN_TEST(quick_test_int_array);
    RUN_TEST(quick_test_long_array);
    RUN_TEST(quick_test_float_array);
    RUN_TEST(quick_test_double_array);
    RUN_TEST(quick_test_char_array);
    RUN_TEST(quick_test_string_array);
    RUN_TEST(quick_test_already_sorted_array);
    RUN_TEST(quick_test_with_only_duplicated);
