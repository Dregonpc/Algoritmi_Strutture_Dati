...
/**
 * @brief It sorts two sub-arrays, then merges them into a temporary array, and is finally copied to the original array.
...
/**
 * @brief Recursive function that divides the array in half, until there is one single element for array. After that they are merged together with the merge function.
 * @param base Is a pointer to the first element of the array to sort
