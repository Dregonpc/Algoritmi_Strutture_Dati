...
void test_long_array(void) {
    long test[] = {1423, 152, 759, 847, 10, 300, 635, 477, 852, 1256, 245, 474, 514, 104, 266, 568, 147, 748, 988, 15};
    long expected[] = {10, 15, 104, 147, 152, 245, 266, 300, 474, 477, 514, 568, 635, 748, 759, 847, 852, 988, 1256, 1423};
    quick_sort(test, 20, sizeof(test[0]), compare_long);
...
void test_float_array(void) {
    ...
    quick_sort(test, 20, sizeof(test[0]), compare_float);
...
void test_double_array(void) {
    ...
    quick_sort(test, 20, sizeof(test[0]), compare_double);
...
void test_char_array(void) {
    ...
    quick_sort(test, 20, sizeof(test[0]), compare_char);
